...
import { Plus, RefreshCw, Edit3, Check, X, Trash2, Clock, LogOut } from 'lucide-react';
...
const App = () => {
  ...
  if (!isAuthenticated) {
    return (
      <div className="flex items-center justify-center min-vh-100" style={{ background: '#f5f5f7' }}>
        <motion.div
        ...
        >
          <h1 className="headline" style={{ fontSize: '32px', marginBottom: '8px' }}>Access Locked</h1>
          <p className="subheadline" style={{ marginBottom: '32px' }}>Please enter the password to continue.</p>
            ...
            <div className="form-group">
              <input
                ...
                style={{
                  textAlign: 'center',
                  fontSize: '18px',
                  borderColor: authError ? '#ff3b30' : undefined
                }}
              />
              {authError && (
